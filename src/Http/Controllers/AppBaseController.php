...
class AppBaseController extends Controller
{
    ...
    /**
     * @var The model name will set the context for the entity that CRUD will be applied to.
     */
    protected $modelName;

    /**
     * @var string the dot notated path to blade view directory from view
     */
    protected $viewPath;
    /**
     * @var The Model object that will likely be instantiated during the extended controller construction.
     */
     ...
     */
    public function setEntityModel(Model $entityModel): void
    {
